...
//$getWP = new ternWP; //-del me
//$ayvpp_options = $getWP->getOption('ayvpp_settings',$ayvpp_options,true); //- del me
...
$utube = new youtube_import($ayvpp_options,$params);// youtube_import();
$data = $utube->progress();
